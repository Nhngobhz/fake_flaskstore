...
app.config.update(
    ...
    MAIL_PASSWORD= os.getenv('flask_secret'),
    MAIL_DEFAULT_SENDER=('Thay', os.getenv('email'))
)

# Initialize once, globally
mail = Mail(app)
# Mock product data to display on the home page
products = [
  {
    "id": 1,
...
def submit_order():
    ...
    msg = Message(subject="Your Order Confirmation", recipients=[email])
    msg.html = html_content

    mailres = mail.send(msg)
